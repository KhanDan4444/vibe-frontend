...
export default function AdminPaymentModal({
  ...
  const inputBase = 'w-full rounded-lg border border-app-input-border bg-app-input py-2.5 text-sm text-app-text-strong placeholder:text-app-muted focus:border-teal-600 focus:outline-none';
    ...
    <ResponsiveModal open={isOpen} onClose={onClose} size="md">
      ...
      <form onSubmit={handleSubmit} onChangeCapture={markTouched} className={`${modalBody} flex-1 space-y-5`}>
          ...
          <div>
            ...
            <select
              className="w-full rounded-lg border border-app-input-border bg-app-input py-2.5 px-4 text-sm text-app-text focus:border-teal-600 focus:outline-none cursor-pointer"
              value={method}
          ...
          <div>
            ...
            <textarea
              rows="2"
              className="w-full rounded-lg border border-app-input-border bg-app-input py-2.5 px-4 text-sm text-app-text focus:border-teal-600 focus:outline-none"
              value={notes}
