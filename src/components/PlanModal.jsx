        ...
        <form onSubmit={handleSubmit} onChangeCapture={markTouched} className="space-y-4">
          ...
          {showDescription && (
            <div>
              ...
              <textarea
                className="mt-1 block w-full h-20 resize-none rounded-lg border border-app-input-border bg-app-input px-3 py-2 text-sm text-app-text-strong focus:border-teal-600 focus:outline-none"
