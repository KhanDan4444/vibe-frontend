      ...
      <div className={`${modalBody} relative`}>
        ...
        <form onSubmit={handleSubmit} onChangeCapture={markTouched} className="space-y-4">
          ...
          <div>
            ...
            <input
              type="text"
              className="mt-1 block w-full rounded-lg border border-app-input-border bg-app-input px-3 py-2 text-sm text-app-text focus:border-teal-600 focus:outline-none"
