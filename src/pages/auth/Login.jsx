// src/pages/auth/Login.jsx — split brand + form on desktop; stacked on mobile
...
import LoginBrandAside from '../../components/auth/LoginBrandAside';
      ...
      <div className="flex min-h-[100dvh] flex-1 flex-col lg:flex-row">
        ...
        <div className="relative flex flex-1 items-center justify-center px-4 py-10 sm:px-6 lg:px-10 xl:px-16">
          <div className="relative w-full max-w-md">
            {/* Mobile / tablet: brand above form. Desktop: brand lives on the left. */}
