...
export const inputSurface =
  'rounded-lg border border-app-border-subtle bg-app-input text-app-text focus:border-teal-600 focus:outline-none focus:ring-2 focus:ring-teal-600/20';

export const selectSurface =
  'h-10 cursor-pointer appearance-none rounded-lg border border-app-border-subtle bg-app-raised bg-[length:16px] bg-[right_10px_center] bg-no-repeat px-3 pr-9 text-sm text-app-text-strong focus:border-teal-600 focus:outline-none focus:ring-2 focus:ring-teal-600/20 disabled:cursor-not-allowed disabled:opacity-60';
