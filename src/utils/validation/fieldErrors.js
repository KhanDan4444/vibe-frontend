...
export const FORM_INPUT_CLASS =
  'mt-1 block w-full rounded-lg border border-app-border-subtle bg-app-raised px-3 py-2 text-sm text-app-text focus:border-teal-600 focus:outline-none focus:ring-2 focus:ring-teal-600/20';
